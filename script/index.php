...
<html lang="en">
	...
	<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
	  ...
	  <div class="w3-display-middle w3-padding-xlarge">
		...
		<h2 class="w3-xlarge w3-text-white w3-codespan"><font color="black">Institut Teknologi Bandung</h2></font>
		<br>
		<br>
	  </div>
	</header>
	...
	<div class="container">
		...
		<font font size="2"><br>Klik 'Kalkulasi' untuk menghitung jarak dan waktu tempuh<br></font>
		...
		<br>
		<br>
		<font face="calibri" font size="4"><b><u>Lokasi tujuan: </u></b><br></font>
